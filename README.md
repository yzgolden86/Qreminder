...
| **通知渠道** | Telegram、邮件（部署级 Resend）、企业微信机器人、Webhook、Bark、NotifyX——6 种渠道可同时启用 |
...
支持 Telegram、邮件、企业微信机器人、Webhook、Bark、NotifyX 六种通知渠道。详细配置步骤见 [docs/NOTIFICATION_CHANNELS.md](./docs/NOTIFICATION_CHANNELS.md)。
